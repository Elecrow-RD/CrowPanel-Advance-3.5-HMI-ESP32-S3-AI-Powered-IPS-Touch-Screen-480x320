...
private:
    ...
    // Maintain the original small screen parameters and only adjust the layout position
    static const int DIALOG_WIDTH = 440;          // Dialog width
    static const int DIALOG_HEIGHT = 280;        // Dialog height
    static const int DIALOG_MARGIN_TOP = 30;     // Top margin
    static const int BUBBLE_RADIUS = 4;         // Bubble corner radius
    static const int BUBBLE_MARGIN = 4;         // Bubble spacing
    static const int TEXT_MARGIN = 5;           // Text margin
    static const int AVATAR_SIZE = 25;           // Avatar size
    static const int AVATAR_MARGIN = 15;          // Avatar margin
    static const int BUBBLE_CONTENT_WIDTH = 250; // Bubble content width
    static const int TEXT_SIZE = 1;              // Text size
    static const int CHAR_WIDTH = 6;             // Character width
    static const int LINE_HEIGHT = 10;           // Line height
    static const int DIALOG_INNER_PADDING = 5;   // Inner padding
    static const int ARROW_WIDTH = 5;           // Arrow width
};
