...
const char* websocket_server = "192.168.2.157";  // Server ip address
...
const i2s_pin_config_t pin_config_mic = {
  .bck_io_num = 9,                   // Serial-Data Clock for I2S interface. For 7.0-inch, 5.0-inch, and 4.3-inch devices, it is 19 /---- For 3.5-inch, 2.8-inch, and 2.4-inch devices, it is 9
  .ws_io_num = 3,                     // Serial Data-Word Select for I2S Interface. For 7.0-inch, 5.0-inch, and 4.3-inch devices, it is 2 /---- For 3.5-inch, 2.8-inch, and 2.4-inch devices, it is 3
  .data_out_num = I2S_PIN_NO_CHANGE,  // Data output pin remains unchanged
  .data_in_num = 10                   // Serial-Data Output for I2S interface. For 7.0-inch, 5.0-inch, and 4.3-inch devices, it is 20 /---- For 3.5-inch, 2.8-inch, and 2.4-inch devices, it is 10
};
...
const i2s_pin_config_t pin_config_spk = {
  .bck_io_num = 13,    // I2S bit clock pin, BCLK. For 7.0-inch, 5.0-inch, and 4.3-inch devices, it is 5 /---- For 3.5-inch, 2.8-inch, and 2.4-inch devices, it is 13
  .ws_io_num = 11,     // I2S left/right channel frame clock pin, LRCLK. For 7.0-inch, 5.0-inch, and 4.3-inch devices, it is 6 /---- For 3.5-inch, 2.8-inch, and 2.4-inch devices, it is 11
  .data_out_num = 12,  // I2S serial data input pin. DATA. For 7.0-inch, 5.0-inch, and 4.3-inch devices, it is 4 /---- For 3.5-inch, 2.8-inch, and 2.4-inch devices, it is 12
