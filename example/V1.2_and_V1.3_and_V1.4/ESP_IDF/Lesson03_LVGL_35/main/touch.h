 ...
 * This header selects the controller used by the lesson and converts
 * raw touch reports into screen coordinates.
 *--------------------------------------------------------------*/
#include <Arduino.h>
...
// Display object declared by the main application file.
extern LGFX gfx;

// Stores the last valid touch position reported by the controller.
...
// Tracks whether the panel is currently being pressed.
...
#if defined(TOUCH_FT6X36)
/**
 * @brief Translate controller events into screen coordinates.
 *
 * @param p Raw point reported by the touch library.
 * @param e Event type reported by the touch library.
 * @return None.
 */
...
/**
 * @brief Check whether the touch controller has a valid signal.
 *
 * @return true when the controller is ready to report coordinates.
...
/**
 * @brief Check whether the panel is currently pressed.
 *
 * @return true if a touch is active.
 * @return false otherwise.
 */
bool touch_touched() {
#if defined(TOUCH_FT6X36)
...
/**
 * @brief Check whether the panel has been released.
 *
 * @return true if the last press has ended.
 * @return false otherwise.
 */
bool touch_released()
{
