...
#if __has_include(<soc/lcd_periph_rgb.h>)
 #include <soc/lcd_periph_rgb.h>
 #define LGFX_LCD_RGB_SIG(idx) (&lcd_periph_rgb_signals.panels[(idx)])
 #define LGFX_LCD_I80_SIG(idx) (&lcd_periph_signals.panels[(idx)])
#elif __has_include(<soc/lcd_periph.h>)
 #include <soc/lcd_periph.h>
 #define LGFX_LCD_RGB_SIG(idx) (&lcd_periph_rgb_signals.panels[(idx)])
 #define LGFX_LCD_I80_SIG(idx) (&lcd_periph_i80_signals.buses[(idx)])
#endif
