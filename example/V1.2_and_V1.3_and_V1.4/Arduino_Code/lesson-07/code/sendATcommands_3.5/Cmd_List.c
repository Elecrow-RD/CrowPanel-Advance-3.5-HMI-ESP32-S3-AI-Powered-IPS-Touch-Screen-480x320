...
/*---------------------------------------------------------------
 * AT command metadata
 * The tables below map command strings to the functions that handle
 * each request and to the text printed back to the serial monitor.
 *--------------------------------------------------------------*/
...
/**
 * @brief Command table used by the parser.
 *
 * Each entry links one AT string to the corresponding get/set/run
 * callbacks.
 */
