...
/*---------------------------------------------------------------
 * Runtime flags shared between AT commands and the main loop
 * A command handler sets a flag, then the foreground loop performs the
 * longer radio operation at a safe time.
 *--------------------------------------------------------------*/
